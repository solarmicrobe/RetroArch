...
enum msg_hash_enums
{
   ...
   MENU_LABEL(INPUT_SENSOR_ORIENTATION),
   ...
   MENU_LABEL(MENU_ALLOW_TABS_BACK),
   ...
   MENU_LABEL(VIDEO_HDR_SCANLINES),
   MENU_LABEL(VIDEO_HDR_SUBPIXEL_LAYOUT),
   ...
   MENU_LABEL(SCAN_METHOD),
   MENU_LABEL(SCAN_USE_DB),
   MENU_LABEL(SCAN_DB_SELECT),
   MENU_LABEL(SCAN_TARGET_PLAYLIST),
   MENU_LABEL(SCAN_SINGLE_FILE),
   MENU_LABEL(SCAN_OMIT_DB_REF),
   ...
   MENU_ENUM_LABEL_HELP_AUDIO_DRIVER_AUDIOWORKLET,
   ...
   MENU_LABEL(CONTENT_INFO_PLAY_COUNT),
   ...
   MENU_LABEL(INPUT_SENSOR_SETTINGS),
...
#ifdef HAVE_SMBCLIENT
   MENU_LABEL(SMB_CLIENT_SETTINGS),
   MENU_LABEL(SMB_CLIENT_ENABLE),
   MENU_LABEL(SMB_CLIENT_AUTH_MODE),
   MENU_LABEL(SMB_CLIENT_SERVER),
   MENU_LABEL(SMB_CLIENT_SHARE),
   MENU_LABEL(SMB_CLIENT_SUBDIR),
   MENU_LABEL(SMB_CLIENT_USERNAME),
   MENU_LABEL(SMB_CLIENT_PASSWORD),
   MENU_LABEL(SMB_CLIENT_WORKGROUP),
   MENU_LABEL(SMB_CLIENT_NUM_CONTEXTS),
   MENU_LABEL(SMB_CLIENT_TIMEOUT),
