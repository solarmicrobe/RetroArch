...
/* Thumbnailpack removal */
   ...
   MENU_LABEL(VIDEO_SHADER_PRESET_REMOVE), /* Deprecated */
   ...
   MENU_LABEL(VIDEO_SHADER_PRESET_SAVE), /* Deprecated */
   ...
   MENU_LABEL(DATABASE_CURSOR_LIST_ENTRY_GENRE),
   ...
   MENU_LABEL(DATABASE_CURSOR_LIST_ENTRY_REGION),
